...
gzip -dc backup_twitter.json.gz |elasticdump --input=$ --output='http://localhost:9200/twitter-restore'  
gzip -dc backup_paste.json.gz |elasticdump --input=$ --output='http://localhost:9200/paste-restore'  
